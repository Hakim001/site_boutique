...
<html lang="en">
  <head>
    ...
    <!-- CSRF Token -->
    <meta name="csrf-token" content="DNsk1pXvVwa4lOAizpB7ZIGwWZyjg1lH7SuFXoSx">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 contenu">
                <div class="jumbotron">
                    <h1 class="display-3">E-shop , En ligne !</h1>
                    <p>Donec vitae erat rutrum, scelerisque erat a, elementum arcu. Interdum et malesuada fames ac ante ipsum primis in faucibus. Vivamus ultricies luctus tincidunt. Suspendisse accumsan elementum orci ut congue. Nulla laoreet libero sem, sit amet dapibus dui condimentum et. Nunc eget elit eu enim suscipit elementum nec eu libero. Pellentesque ac imperdiet nisi. Mauris facilisis, turpis in vehicula faucibus, leo nisi pulvinar sapien, ut maximus justo tortor in turpis.</p>
                ...
                <div class=" row pubs">
                    <div class="col-md-6 ">
                        <div class="pub  ">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4>Iusto quis quasi eos sapiente dolore voluptatem laudantium sed.</h4>
                                    <p>Ipsam pariatur provident ullam voluptatem qui. Commodi et eum suscipit aspernatur et sit laborum. Iu... </p>
                                    <a href="http://shop.dev/produit/iusto-quis-quasi-eos-sapiente-dolore-voluptatem-laudantium-sed">voir détails</a>
                                </div>
                                <div class="col-md-6">
                                    <img src="https://lorempixel.com/400/400/sports/Faker/?49596" alt="Iusto quis quasi eos sapiente dolore voluptatem laudantium sed.">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 ">
                        <div class="pub pub-primary ">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4>Et non quia molestiae cumque sed quibusdam.</h4>
                                    <p>Quod autem facilis quia ratione reprehenderit. Omnis id ut quia facere est ipsam reiciendis. Consequ... </p>
                                    <a href="http://shop.dev/produit/et-non-quia-molestiae-cumque-sed-quibusdam">voir détails</a>
                                </div>
                                <div class="col-md-6">
                                    <img src="https://lorempixel.com/400/400/technics/Faker/?69498" alt="Et non quia molestiae cumque sed quibusdam.">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="footer">
        <div class="container">
            ...
            <div class="row line footer_infos">
                <div class="col-md-6"><p class="copyright">Copyright - athakim (c) 2017 - Tous les droits réservés . </p></div>  
                <div class="col-md-6">
                    <ul>
                        <li> <a href=""><i class="fa fa-google-plus"></i></a> </li>
                        <li> <a href=""><i class="fa fa-facebook"></i></a> </li>
